...
const Denied = async () => {
  ...
  <p className='font-sans mt-3 italic font-bold text-lg'>Please <a className='text-black font-[900] underline italic font-sans tracking-widest' href="https://www.facebook.com/apple.courses.netlify.app.3.0/">buy</a> access to continue.</p>
<a className='mt-5 bg-gray-900 text-white px-3 py-2 mb-2 rounded-md font-sans font-extrabold shadow-lg shadow-gray-200 hover:shadow-none active:tracking-widest ring-1 ring-pink-950' href="https://applecourses.netlify.app">Back to Apple Shop</a>
